...
% This package makes it possible to include custom fonts,
% but works only with lualatex/xelatex, not pdflatex
\RequirePackage{fontspec}
% Latin modern as default serif font
\setmainfont{Latin Modern Roman}
% Use the font Technika-Bold.otf as bold sans font (mostly used in titles),
% as can be seen in the "ctustyle" template for TeX
% It is needed to have this font installed in your system or in texmf folder
\setsansfont[
WordSpace={1.2},
BoldFont={Technika-Bold}%
]{Latin Modern Sans}
...
%%% GEOMETRY
% I adjusted this to make it a bit wider from 33 to 36
% Target textwidth is 33*basesize (10pt to 12pt)
\dim_const:Nn \g_ctuthesis_geometry_textwidth_dim { \tl_use:N \g_ctuthesis_fontsize_tl * 36 }
...
% Entry line in list of figures and list of tables - the section number is bold
\def\ctu@dottedtoclinebold#1#2#3#4#5{\ifnum #1>\c@tocdepth \else
	\addvspace{0pt plus .2pt}
	{
	\leftskip #2\relax
	\rightskip\dimexpr\@tocrmarg plus 1fil
	...
	\hskip -\leftskip
	% section number
	\def\numberline##1{\sffamily\bfseries##1\ \rmfamily\mdseries\kern0.2em}
	{#4}
	\nobreak
	\leaders \hbox {$\m@th \mkern 2mu\hbox {.}\mkern 2mu$}\hfill
	\nobreak
...
\def\l@figure{\ctu@dottedtoclinebold{-2}{2em}{0em}}
\let\l@table\l@figure
\let\l@lstlisting\l@figure

% Add List of Listings command
\DeclareDocumentCommand \listoflistings {  }{ \ctuthesis_maketoc_twocol:nn { lol } { \lstlistlistingname } }
...
\restylefloat{figure}
% captions of tables should be above them
\floatstyle{plaintop}
\restylefloat{table}
...
\ctuifswitch { pkg-hyperref } {
	...
	\hypersetup{
		...
		unicode=true,
		% PDF metadata in main language
		pdftitle = \ctuthesis_field_use:nn { main } { title },
		pdfauthor = \ctuthesis_field_use:n { author },
		pdfkeywords = \ctuthesis_field_use:nn { main } { keywords },
		pdfsubject = \ctuthesis_field_use:nn { main } { doctype }
	}
}{}
