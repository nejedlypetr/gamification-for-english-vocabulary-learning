...
\begin{itemize}
    ...
    \begin{figure}[!h]
        \includegraphics[width=0.8\textwidth]{src/figures/duocards-memo.png}
...
\begin{itemize}
    ...
    \begin{figure}[!h]
        \includegraphics[width=1\textwidth]{src/figures/duolingo-exercise-types.png}
    ...
    \begin{figure}[!h]
        \includegraphics[width=1\textwidth]{src/figures/duolingo-lesson-review.png}
    ...
    \begin{figure}[!h]
        \includegraphics[width=1\textwidth]{src/figures/duolingo-streak.png}
